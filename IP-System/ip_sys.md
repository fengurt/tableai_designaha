...
4. **不可动项**：复审可改愿景、受众、定位、人格；使命与核心价值观按 Collins & Porras 原则原地不动——若连它们都要改，那不是复审，是重新创业。
...
2. **偏离流程**：允许创意偏离手册，但须提交"偏离申请"说明理由与回收计划——治理的目的是让偏离**可见**，不是禁止偏离。
...
裁剪原则：低权重项不是不答，而是先给"够用版"（一两句话），把工作坊时间和预算集中在 ★★★★ 项。
